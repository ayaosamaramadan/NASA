...
const TypeMap = () => {
 ...
 className='z-[2000] m-15 fixed' >
        <Link to="/">
                        <button title='back' className="top-10 rotate-46 cursor-none left-10 p-3 hover:bg-cyan-500/40 border border-cyan-500/90 transition-all duration-300 text-white text-2xl hover:shadow-lg hover:shadow-cyan-500/30 hidden md:block">
